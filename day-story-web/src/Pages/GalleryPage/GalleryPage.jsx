    ...
    useEffect(() => {
        const fetchImages = async () => {
            ...
            const data = [
                ...
                { date: '2024-04-10', imageUrl: '', title: 'img' },
                { date: '2024-04-15', imageUrl: '', title: 'img' },
            ...
            if (!todayExists) {
                data.unshift({
                    ...
                    imageUrl: 'https://www.petimce.com/i/l/002/0024015_en-populer-kedi-cinsleri-ve-benzersiz-ozellikleri.jpeg',
                    title: "Today's Image"
                });
            }

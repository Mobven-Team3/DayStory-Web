...
// NotesContext ve useNotes fonksiyonlarını tanımlayın
    ...
    const handleAddNote = async () => {
        ...
        try {
            ...
            if (response.status === 200 || response.status === 201) {
                ...
                console.error('Not ekleme başarısız oldu:', response.data);
                setErrorMessage('Not ekleme başarısız oldu.');
                setSuccessMessage('');
            }
        } catch (error) {
            console.error('Not ekleme hatası:', error);
            setErrorMessage('Not ekleme sırasında bir hata oluştu.');
            setSuccessMessage('');
        }
    };
        ...
        <NotesContext.Provider value={{ notes, setNotes }}>
            <div>
                ...
                <div className="note-container">
                    <h1>Notlar</h1>
                    <button onClick={handleModalOpen}>Not Ekle</button>
                    {notes.map(note => (
